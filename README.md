...
# Alternative: use MLX Audio (experimental, opt-in, Apple Silicon local models)
...
[transcription]
engine = "whisper"        # "whisper" (default), "parakeet", "mlx-audio" (experimental), or "apple-speech" (experimental)
